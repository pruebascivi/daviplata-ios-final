	...
	public void ingresarAApp(String tipoDocumento, String usuario, String contrasena) {
		...
		if (estadoVisibilidadPopUP == true) {
            ...
            if (validarBiometria == true) {
    			...
    			String login = utilidadesTCS.capturaDispositivoSrcFile("codigo", "src/test/resources/imagenes/screenshotBase");
    	        int[] cordBotonMov = utilidadesTCS.localizarElementoPorImagen(login,
    	                "src/test/resources/imagenes/templates/Login/campoOtp.png",
    	                "src/test/resources/imagenes/screenshotOutput/campoOtp.png",
    	                Imgproc.TM_CCOEFF_NORMED, 20);
    			utilidadesTCS.clickCoordinates(cordBotonMov[0],cordBotonMov[1]);
